...
DHTABLE = [ pi/2      0         l(1)     q1;
             ...
             0        l(3)        0      q3];
[~,A] = DHMatrix(DHTABLE);
M = simplify([modNE([0;0;0],[0;0;0],[1;0;0],m,I,A,pc,0) modNE([0;0;0],[0;0;0],[0;1;0],m,I,A,pc,0) modNE([0;0;0],[0;0;0],[0;0;1],m,I,A,pc,0)]);
C = simplify([modNE(dq,[1;0;0],[0;0;0],m,I,A,pc,0) modNE(dq,[0;1;0],[0;0;0],m,I,A,pc,0) modNE(dq,[0;0;1],[0;0;0],m,I,A,pc,0)]);
...
lambda_1 = min(min_first,min_third)/2
lambda_2 = max(max_second,max_third)/2
