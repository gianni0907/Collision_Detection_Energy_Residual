function plot_data_fullstate(q_des,dq_des,q,dq,u,u_ext,r,P_ext,t)
...
plot(t,dq_des(1,:));
plot(t,dq(1,:));
legend('$\dot{q}_{1,des}$','$\dot{q}_{1}$',"Interpreter","Latex");
subplot(3,1,2)
hold on,grid on,xlabel("[s]","Interpreter","Latex"),ylabel("[rad/s]","Interpreter","Latex");
plot(t,dq_des(2,:));
plot(t,dq(2,:));
legend('$\dot{q}_{2,des}$','$\dot{q}_{2}$',"Interpreter","Latex");
subplot(3,1,3)
hold on,grid on,xlabel("[s]","Interpreter","Latex"),ylabel("[rad/s]","Interpreter","Latex");
plot(t,dq_des(3,:));
plot(t,dq(3,:));
legend('$\dot{q}_{3,des}$','$\dot{q}_{3}$',"Interpreter","Latex");
